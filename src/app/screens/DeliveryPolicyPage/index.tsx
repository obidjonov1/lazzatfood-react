    ...
    <Container>
      <div className="about-us__title">
        ...
        <span>
          ...
          delivering the mails to customers. All the precautionary measures are
          taken to ensure that the goods arrive in perfect condition, depending
          on their type. During hot summer days, products such as meat are
          shipped with ice packs and in a special foam block.
          <br /> <br />
          ...
          Delivery for orders over ₩100.000 regardless of the size of the mail.
          <br /> <br />
          ...
          Friday will ship the same day. And you can get them the next day. This
          especially contributes to the quality of food delivery.
        </span>
      </div>
    </Container>
  );
