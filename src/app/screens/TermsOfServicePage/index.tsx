...
export function TermsOfServicePage() {
  return (
    <Container>
      <div className="about-us__title terms">
        <h2>TERMS OF SERVICE</h2>
        <p>OVERVIEW</p>
        <span>
          This website is operated by PLUS LAZZATFOO CO.LTD. Throughout the
          site, the terms “we”, “us” and “our” refer to PLUS LAZZATFOO CO.LTD
          ...
          <br /> <br />
          <b> SECTION 1 - ONLINE STORE TERMS </b> <br /> By agreeing to these
          ...
          quantities. We have made every effort to display as accurately as
          ...
          account and other information, including your phone number, email
          address, so that we can complete your transactions and contact you as
          needed.
          <br /> <br />
          ...
          any related website. You may not use a false phone number, e-mail
          ...
          solely responsible for any comments you make and their accuracy. We
          take no responsibility and assume no liability for any comments posted
          by you or any third-party.
          <br /> <br />
          <b>SECTION 10 - PERSONAL INFORMATION</b> <br />
          Your submission of personal information through the store is governed
          by our Privacy Policy. Please review our Privacy Policy carefully.
        </span>
      </div>
    </Container>
  );
